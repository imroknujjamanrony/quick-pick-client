...
const Notification = () => {
  return (
    <div className="bg-[#634C9F] text-[12px] font-medium text-white md:px-48 py-2 text-center">
    <div className="bg-[#634C9F] text-[12px] font-medium text-white flex justify-between py-2">
      <div>
        <h1>
